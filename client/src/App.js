              ...
              <section>
                <Switch>
                  ...
                  />
                                   ...
                                   <Route path="/explore_loans" exact component={Explore_Loans}/> 
                 <Route path="/explore_loans_page" exact component={Explore_Loans_Page}/> 
                 <Route path="/explore_loans_page1" exact component={Explore_Loans_Page1}/> 
                 <Route path="/explore_loans_page2" exact component={Explore_Loans_Page2}/> 
                 <Route path="/explore_loans_page3" exact component={Explore_Loans_Page3}/> 
                 <Route path="/explore_loans_page4" exact component={Explore_Loans_Page4}/> 
                 <Route path="/explore_loans_page5" exact component={Explore_Loans_Page5}/> 
                  <Route
                    exact
