            ...
            <div className="subSectionB_Sidebar">
              <ul className="subSectionB_Sidebar_Ul ">
                ...
                <li
                  ...
                  data-aos-duration="3000"
                >
                  <a href="/the-egoras-dollar" className="subSectionB_SidebarA">
            ...
            <div className="aboutEgoras_card">
              <div className="subSectionC_Card">
                ...
                <div className="cardText">
                  {" "}
                  <Link to="/how-egoras-treasury-work">
                    <ArrowBack className="SubForwardIcon" />
                  </Link>{" "}
                  <div style={{ textAlign: "right" }}>
                    How Egoras Treasury <br /> Work{" "}
                  </div>{" "}
                </div>
              </div>
              <div className="subSectionC_Card Card12">
                ...
                <div className="cardText">
                  <div>
                    {" "}
                    how is the Treasury <br /> Capitalized?
                  </div>
                  <Link to="/how-is-the-treasury-capitalized">
