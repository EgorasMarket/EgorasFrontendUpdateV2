    ...
    <div>
      ...
      <section className="gtheroSection">
        <div className="gtheroArea">
          <div className="gtheroTxts">
            ...
            <p className="gtheroPara">
              Use your items as collaterals to access low interest loans over
              <br /> ₦5m at 0.5% monthly.
            </p>
            <ul className="gtherobuttons">
              <a href="/login" className="gtgetLoan">
                Login
              </a>

              <a href="/signup" className="gtconnect">
                Sign up
              </a>
            </ul>
          </div>
          ...
          <div className="hero-images">
            ...
            <img src="/img/greencircle.svg" alt="" className="greenCircle" />
        ...
        <div className="gtbottomCards">
          <a href="/support" className="gtcard1 active ">
          ...
          <a href="/support" className="gtcard2 ">
            <h3 className="gtsupport">
              I want to Support
              <br />
              <span className="gtsupportPara">Check how you can help</span>
        ...
        <Carousel
          ...
          className="gtheroCard"
          showDots={true}
        >
          <div className="gtcard1 active ">
            <h3 className="gtsupport">
              I want to Support
              <br />
              <span className="gtsupportPara">Check how you can help</span>
      ...
      <section className="collateralize">
        <div className="collateral-area">
          <div className="collateral-txt">
            ...
            <a href="/collateral" className="collat-btn">
      ...
      <section className="gthowItWorks">
        ...
        <a href="#" className="gtgetStartedButton">
          Get Started
        ...
        <div className="gtbenefitsArea">
          <div className="gtbenefitCard1">
            ...
            <div className="gtbCardTexts">
              ...
              <p className="gtbCardPara">
                ...
                hands.Unlike other lenders, we don't make you jump through hoops
          ...
          <div className="gtbenefitCard2">
            ...
            <div className="gtbCardTexts">
              ...
              <p className="gtbCardPara">
                Unlike other lenders that charge exorbitant interest rate (over
                30% monthly). Egoras offers the Market leading interest rates(1%
                monthly) which makes the repayment stressfree with zero hassle.
              </p>
            </div>
          </div>
          ...
          <div className="gtbenefitCard3">
            ...
            <div className="gtbCardTexts">
              ...
              <p className="gtbCardPara">
                Once you're ready to get loans all you have to do is to book an
                appointment with us at the nearest Egoras branch or tell us what
                pickup is convenient for you - location, date, time. Our team
                will take over from there right up to your doorstep and final
                payment. You'll be surprised how smooth this is.
              </p>
            </div>
          </div>
          ...
          <div className="gtbenefitCard4">
            ...
            <div className="gtbCardTexts">
              <h1 className="gtbCardTitle">Lowest Interest Rate</h1>
              <p className="gtbCardPara">
                Unlike other lenders that charge exorbitant interest rate (over
                30% monthly). Egoras offers the Market leading interest rates(1%
                monthly) which makes the repayment stressfree with zero hassle.
      ...
      <section className="discountSection">
        <div className="discountArea">
          <div className="discountTxt">
            Get 50% discount
            <br /> when you pay Interest <br />
            with
            <span className="egr"> EGR.</span>
            <p className="discount-para">
              For your convenience,if you choose
              <br /> to use EGR token to pay the interest, you will enjoy a{" "}
              <br />
              50% discount on the interest charges.
            </p>
        ...
        <div className="gtcompareArea">
          <div className="compareCard">
            <div className="compareCardContent1">
              <h4 className="cardContentTitles">Other banks</h4>
            ...
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Transfer Fee</h6>
            ...
            <hr />
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Debit Card</h6>
              <h6 className="cardContentTxt">
                <RemoveCircleIcon className="removeCircle" />
                ₦1000 plus V.A.T{" "}
              </h6>
            ...
            <hr />
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Card Maintenance Fee</h6>
              <h6 className="cardContentTxt">
                <RemoveCircleIcon className="removeCircle" />
                Up to ₦50 per quater
              </h6>
            ...
            <hr />
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Alerts</h6>
              <h6 className="cardContentTxt">
                <RemoveCircleIcon className="removeCircle" />
              ...
              <h6 className="cardContentTxt">
                {" "}
                <CheckCircleIcon className="checkCircle" />
                Free instant notification
              </h6>
            </div>
            <hr />
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Annual Interest</h6>
              <h6 className="cardContentTxt">
                <RemoveCircleIcon className="removeCircle" />
                4%
              </h6>
            ...
            <hr />
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Bill Payment Fee</h6>
              <h6 className="cardContentTxt">
                <RemoveCircleIcon className="removeCircle" />
                Up to ₦100 per bill
              </h6>
            ...
            {/* <hr />
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Instant Reversals</h6>
              <h6 className="cardContentTxt">
                <RemoveCircleIcon className="removeCircle" />
                Up to ₦50 plus V.A.T{" "}
              </h6>
            ...
            <hr />
            <div className="compareCardContent2">
              <h6 className="cardContentTxt">Account Maintenance Fee</h6>
              <h6 className="cardContentTxt">
                <RemoveCircleIcon className="removeCircle" />
                Yes
              </h6>
        ...
        <div className="gtexploreArea">
          <div className="gtexploretxts">
            ...
            <div className="gtexploreLink">
              <a href="/explore" className="gtexploreLoansbtn">
                Explore loans
              </a>
            </div>
          </div>
