    ...
    <div>
      ...
      <section className="tokenSection" id="token">
        <div className="container">
          ...
          >
            <img src="/img/token-right.svg" alt="" className="mainTokenflex" />
            <div className="tokenCardflex-txt">EGC Token Analysis.</div>
          </div>
          <div className="row">
