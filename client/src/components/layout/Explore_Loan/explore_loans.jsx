                ...
                <div className="section2DivHolder_img">

                    {
                        !categoryChange ?(
                            ...
                            generalData.map((loan, i) => {
                            ...
                            ) :(<div style={{textAlign:'center',margin:'0px auto'}}>Is Empty</div>)
                            ): !isEmpty ? (
                             mainLoanData.map((loan, i) => {
                                ...
                                <div className=" " style={{width:'100%',position:'relative',}}>
                                    <div  className="" style={{display:'flex',flexDirection:'column',justifyContent:'center',alignContent:'center'}}>
                                        <div    style={{width:'80%',margin:'0px auto'}}><img src="/img/sorry-image.svg" alt="" style={{width:'50%'}}/></div>
                                        <div  style={{width:'80%', margin:'0px auto'}}> Oops No data found</div>
                                    </div>
                                </div>
                            )
                    }
