...
const LoanDetails = ({match, loans ,messenger }) => {
    ...
    axios.get(api_url + "/api/loans/get/by/id/"+match.params.id, null, config)
            .then(function (response) {
              axios.get(api_url + "/api/loans/system/info/"+response.data.data[0].loanID, null, config).then((data) =>{
                ...
                setLoanDetailData({...loanDetailData, ['validated']: d._validate, ['isActiveVotingPeriod']: (theCountDown >= now), ['is_approved']: d._state,
  ...
  return (
    <div>
      {/* hero section start */}
      <section className="heroSection2 w-100">
        <div className="heroArea2">
          ...
          <div className="hero-images" data-aos="zoom-in">
            ...
            <div className="card-amount">
              ...
              <p className="amount">$<NumberFormat thousandSeparator={true} thousandsGroupStyle="usd" displayType={'text'} value={parseFloat(loanData.loan_amount)} /></p>
            </div>
          </div>
        </div>
        <img
          ...
          <div className="loanDetailsDays">
            <div className="loanDetailsCards" data-aos="fade-right">
              <div className="detailsCard1">
                ...
                <h1 className="ldAmount1">$<NumberFormat thousandSeparator={true} thousandsGroupStyle="usd" displayType={'text'} value={parseFloat(loanData.loan_amount)} /></h1>
              </div>
            ...
            <div className="ldCardTexts2" data-aos="fade-right">
              Disbursed date: <span className="payment"> <Moment format="D MMM YYYY" withTitle>{loanData.updatedAt}</Moment></span>
            </div>
                ...
                return (
                  ...
                  <a href={"/loan-details/" + loan.id}>
                    <div className="cardA">
                      ...
                      >
                        <div className="img-amount"><NumberFormat value={parseFloat(loan.loan_amount)} displayType={'text'} thousandSeparator={true} prefix={'$'} /></div>
                      </div>
